...
\begin{resume}
    ...
    %To obtain a full time computer programming position in the field of artificial intelligence. 
   ...
   %\textbf{Springfield Technical Community College}, Springfield, Massachusetts \vspace{1mm}\\\vspace{1mm}%
   %\textsl{Computer Science AS} \hfill \textbf{ September 2003 -- May 2005}\vspace{-3mm}\\\vspace{-1mm}%
   %\begin{list2}
   %  \item GPA: 3.67
   ...
   %Introduction to Artificial Intelligence, Neural Networks and Machine Learning, Mobile Robot Programming,
